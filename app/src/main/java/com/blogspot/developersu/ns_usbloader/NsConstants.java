...
public class NsConstants {
    ...
    public static final String NS_SERVICE_CONTENT_NSP_LIST = "NSP_LIST";
    public static final String NS_SERVICE_CONTENT_PROTOCOL = "PROTOCOL";
    public static final String NS_SERVICE_CONTENT_NS_DEVICE = "DEVICE";
    public static final String NS_SERVICE_CONTENT_NS_DEVICE_IP = "DEVICE_IP";
    public static final String NS_SERVICE_CONTENT_PHONE_IP = "PHONE_IP";
    public static final String NS_SERVICE_CONTENT_PHONE_PORT = "PHONE_PORT";
